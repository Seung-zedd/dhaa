...
**Recommended**: Claude Code **2.1.111 or later** for Opus 4.7+ support (incl. Opus 5), MCP doctor warnings, and Windows CLAUDE_ENV_FILE parity. Minimum baseline: **2.1.97** for worktree isolation.
